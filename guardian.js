...
import { doc, getDoc, updateDoc, serverTimestamp } from "https://www.gstatic.com/firebasejs/11.2.0/firebase-firestore.js";
 ...
 */
const LIST_SEXUAL = [
    "porn", "pornography", "xxx", "nude", "nudity", "sex", "sexual",
    "erotic", "hentai", "camgirl", "blowjob", "anal", "oral",
    "dick", "pussy", "vagina", "penis", "cum", "sperm", "orgasm",
    "fetish", "bondage", "bdsm", "incest", "pedophile", "pedo",
    "rape", "molest", "masturbate", "masturbation", "tit", "tits",
    "boob", "boobs", "nipple", "clitoris", "vulva", "cock",
    "milf", "dilf", "twink", "femboy", "tranny", "shemale",
    "onlyfans", "pornhub", "xvideos", "brazzers", "xhamster",
    "nsfw", "nsfl", "hardcore", "softcore", "gangbang", "threesome",
    "bukkake", "creampie", "deepthroat", "doggystyle", "facials",
    "finger", "fingering", "fisting", "handjob", "rimjob",
    "squirt", "squirting", "swallow", "swallowing", "voyeur",
    "upskirt", "downblouse", "jailbait", "lolicon", "shotacon"
];
...
const LIST_MALWARE = [
    ...
    "keylogger", "rootkit", "botnet", "adware", "scareware",
    "exploit", "cve-", "zeroday", "0day", "payload", "shellcode",
    "hacking", "hacker", "hack", "warez",
    "ddos", "dos attack", "denial of service", "packet sniffer",
    "sql injection", "sqli", "xss", "cross-site scripting", "csrf",
    "rce", "remote code execution", "buffer overflow", "heap spray",
    "brute force", "bruteforce", "rainbow tables", "hashcat",
    "john the ripper", "metasploit", "kali linux", "wireshark",
    "nmap", "burp suite", "dark web", "darknet", "tor browser",
    "onion site", "silk road", "carding", "carder", "cc dump",
    "fullz", "phishing", "phish", "stealer", "rat", "remote access tool",
    "fud", "fully undetectable", "crypter", "binder", "bot",
    "botting", "script kiddie", "dox", "doxing", "swatting"
];
 ...
 */
const LIST_HATE = [
    "nigger", "israel", "nigga", "faggot", "kike", "spic", "chink", "wetback",
    "gook", "raghead", "towelhead", "retard", "mongoloid",
    "hitler", "nazi", "white power", "kkk", "isis", "jihad",
    "terrorist", "osama bin laden", "genocide", "suicide", "whitey"
];
...
export function validateContent(text) {
    ...
    if (/(.)\1{9,}/.test(text)) { // 10+ same chars
        severityScore += 10;
        if (!primaryCategory) {
...
function getSeverityForCategory(category) {
    switch (category) {
        case "SEXUAL_CONTENT": return 100; // Immediate block
        case "MALWARE_HACKING": return 100; // Immediate block
        case "HATE_SPEECH": return 80; // High severity
        case "OBFUSCATION": return 50;
        case "SPAM": return 20;
        default: return 10;
    }
}
